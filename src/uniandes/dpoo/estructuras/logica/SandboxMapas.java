...
public class SandboxMapas
{
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        for (int i = 1; i < llaves.size(); i++) {
            String key = llaves.get(i);
            int j = i - 1;
            while (j >= 0 && llaves.get(j).compareTo(key) < 0) { 
                llaves.set(j + 1, llaves.get(j));
                j--;
            }
            llaves.set(j + 1, key);
        }
    ...
    public String getPrimera( )
    {
        ...
        String menor = null;
        for (String k : mapaCadenas.keySet()) {
            if (menor == null || k.compareTo(menor) < 0) {
                menor = k;
            }
        }
        return menor;
    ...
    public String getUltima( )
    {
        ...
        String mayor = null;
        for (String v : mapaCadenas.values()) {
            if (mayor == null || v.compareTo(mayor) > 0) {
                mayor = v;
            }
        }
        return mayor;
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        // Recorremos manualmente las llaves del mapa
